...
public class ReportActivityMonthly extends AppCompatActivity implements OnMapReadyCallback {
        ...
        protected void onCreate(Bundle savedInstanceState) {
            ...
            mWeekly = findViewById(R.id.weeklyReport);
            mBack2 = findViewById(R.id.backToMenu2);
            ReportText = (TextView)findViewById(R.id.monthlyReportText1);

            mWeekly.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    openActivityReportWeekly();
                }
            });
        ...
        public void openActivityReportWeekly(){
